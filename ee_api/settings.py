"""
Django settings for ee_api project.
...
SECRET_KEY = '6-otpzisphdel%snw4mz6=!rqsq0&qfhk^dy&l-xzp^k&prmgu'
...
WSGI_APPLICATION = 'ee_api.wsgi.application'
...
STATIC_ROOT = os.environ.get('STATIC_ROOT', '{}/ee_api/static/'.format(BASE_DIR))
...
MEDIA_ROOT = os.environ.get('MEDIA_ROOT', '{}/ee_api/media/'.format(BASE_DIR))
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # 'ee_api.base.auth.jwt.JWTAuthentication',
    ),

    'DEFAULT_PERMISSION_CLASSES': (
        # 'ee_api.core.permissions.AllowSafeMethods',
    ),
